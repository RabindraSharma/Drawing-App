    ...
    uglify: {
      ...
      my_target: {
        files: {
          ...
          './plugins/main/wPaint.menu.main.min.js': ['./plugins/main/src/wPaint.menu.main.js', 'paint/plugins/main/src/fillArea.min.js'],
          './plugins/text/wPaint.menu.text.min.js': ['./plugins/text/src/wPaint.menu.text.js'],
          './plugins/shapes/wPaint.menu.main.shapes.min.js': ['./plugins/shapes/src/wPaint.menu.main.shapes.js', 'paint/plugins/shapes/src/shapes.min.js'],
